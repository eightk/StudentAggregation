 ...
 * 1. every single row should have 4 sections: province, city, school and grade+number
 * 2. grade+number format by default should be: the first letter should be either 'k' or 1-8, 
 * the next 4 digits should all be number and total length is 5. Can set the pattern to change the format.
 * 3. output file content can be controlled by different variables, by default, we only print province, city and school.
 *  
 * 
...
public class StudentAggregationDriver extends AbstractAggregationDriver {
	...
	/**
	 * Read in the value from input stream: can be File, Database, String or any other possible input streams.
	 * Handle the information as it is read in.
	 * 
	 * @return a Map object contains all 4 aggregation results for province, city, school and grade.
	 */
	@Override
	...
	/**
	 * Method for printing the result to the output stream.
	 * The assumption is the resultMaps should be the one generated by aggregateRecords method
	 */
	@Override
